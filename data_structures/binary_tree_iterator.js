  ...
  next() {
    ...
    while (!nextFound) {
      ...
      if (this.prev === this.curr.parent) {
        // came from parent
        nextFound = true;
        next = this.curr.left || this.curr.right || this.curr.parent;
      } else if (this.prev === this.curr.left) {
          // came from left
          // nextFound = true;
          next = this.curr.right || this.curr.parent;
      } else { // this.pev === this.curr.right
          // came from right, must be backtracking
          next = this.curr.parent;
      }
      this.prev = this.curr;
      this.curr = next;
...
console.log('Run: testPreorderIterator');
...
function testPreorderIterator() {
  ...
  let it = new PreorderIterator(root);
  while(it.hasNext()) {
    console.log(it.next());
  }
}
